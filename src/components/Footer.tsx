  ...
  return (
    <footer className="bg-brand-dark text-[#F6EFE3]/80 border-t border-brand-gold/15 py-16 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
        ...
        <div className="flex flex-col space-y-6">
          <Link to="/" className="flex flex-col items-start leading-none group">
            <span className="font-telugu text-3xl text-brand-bg font-bold group-hover:text-brand-accent transition-colors duration-300">
              ఉస్తాద్స్
            </span>
            <span className="font-display tracking-widest text-xs uppercase font-semibold text-brand-gold ml-0.5 mt-1">
              USTAADS
            </span>
          </Link>
          <p className="font-sans text-sm leading-relaxed text-[#F6EFE3]/60">
            Crafting the finest Hyderabadi culinary heritage. Loved for our rich signature Dum Biryani and authentic spices, served with premium hospitality in Hyderabad.
          </p>
          <div className="flex space-x-4">
            <a href="tel:+919063878223" className="w-9 h-9 flex items-center justify-center rounded-full border border-brand-bg/15 hover:border-brand-gold hover:text-brand-gold transition-all duration-300" aria-label="Call Phone">
            ...
            <a href="https://instagram.com/ustaads" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-full border border-brand-bg/15 hover:border-brand-gold hover:text-brand-gold transition-all duration-300" aria-label="Instagram">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <a href="https://facebook.com/ustaads" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-full border border-brand-bg/15 hover:border-brand-gold hover:text-brand-gold transition-all duration-300" aria-label="Facebook">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          <ul className="space-y-3 font-sans text-sm text-[#F6EFE3]/70">
            <li className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#F6EFE3]/50">12:00 PM – 11:00 PM</p>
              </div>
            </li>
            <li className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#F6EFE3]/50">Dine In • Drive Through • No Contact Delivery</p>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <ul className="space-y-3 font-sans text-sm text-[#F6EFE3]/70">
            <li className="flex items-start space-x-3">
              ...
              <span>Plot 54, Street Number 1, Moinabad, Hyderabad, Telangana 500075</span>
            </li>
            <li className="flex items-center space-x-3">
              <Phone size={16} className="text-brand-gold shrink-0" />
              <a href="tel:+919063878223" className="hover:text-brand-gold transition-colors">090638 78223</a>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-[#F6EFE3]/10 flex flex-col sm:flex-row justify-between items-center text-xs text-[#F6EFE3]/40 font-sans">
        <p>© {currentYear} Ustaads Restaurant. All Rights Reserved.</p>
